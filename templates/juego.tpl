          ...
          <div class="card lastplayed">
            ...
            <div class="card-body">
              <ul class="list-group lastplayedlist">
                <li class="list-group-item dark top5li"><img class="atinyimg" src="{$home}/images/vegetta.png">  Vegetta</li>
                <li class="list-group-item semidark top5li"><img class="atinyimg" src="{$home}/images/venomist.png">  VenoMist</li>
                <li class="list-group-item dark top5li"><img class="atinyimg" src="{$home}/images/juanpe.png">  Juanpe</li>
                <li class="list-group-item semidark top5li"><img class="atinyimg" src="{$home}/images/kirito.png">  Kirito</li>
                <li class="list-group-item dark top5li"><img class="atinyimg" src="{$home}/images/balrogam.png">  Balgoram</li>
              </ul>
            </div>
          </div>
        </div>
